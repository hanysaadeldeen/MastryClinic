<template>
  ...
  >
    <div class="container relative mx-auto text-white max-w-[1320px]">
      ...
      <h1
        class="mt-4 px-4 text-center text-sm font-normal text-paragraph md:mt-6"
      >
        {{ $t("footer.copyright") }}
      </h1>
    </div>
